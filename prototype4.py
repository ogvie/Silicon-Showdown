...
#root.geometry('2560x1440')  # Set the initial dimensions of the window
...
def options():
    ...
    # Create a "Back" button with specified text, font, and command to be executed when clicked
    backbtn = Button(root, text="Back", font=("font2.ttf", 20), command=main_menu)

    # Pack the "Back" button in the GUI, specifying its position, padding in the x and y directions
    backbtn.pack(side='top', padx=10, pady=10)
